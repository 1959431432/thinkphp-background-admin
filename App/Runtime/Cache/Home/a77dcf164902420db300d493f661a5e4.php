...
<div id="leftSide">
    ...
    <div class="nextUpdate">
        <ul>
            ...
            <li>还需
                <?php  $progressWidth = $_user['level'] / $_nextGroup['integral'] * 100; echo $_nextGroup['integral'] - $_user['level']; ?></li>
        </ul>
...
<div id="rightSide">
    ...
    <div class="topNav">
        <div class="wrapper">
            ...
            <div class="userNav">
                <ul>
                    <li><a href="#" title=""><img src="/Public/images//icons/topnav/profile.png" alt="" /><span>个人资料</span></a></li>
...
<iframe id="showIframe" src="//baidu.com" style="margin-top: 28px;width: 100%;position: absolute;"></iframe>
<div id="clicktest" style="position: fixed;bottom: 10px;background: #F44336;border-radius: 40px;width: 40px;height: 40px;line-height: 40px;text-align: center;color: #fff;cursor: pointer;right: 20px;float: right;z-index: 999;">隐藏
</div>
<script type="text/javascript">
	$(function()
	{
		var bodyHeight = document.body.scrollHeight;
		$("#showIframe").css('height',bodyHeight);
		$("#clicktest").click( function(){
			var h = $(this).html();
			if( h == '显示'){
				$('#leftSide').show();
				$(this).html('隐藏');
				$("#showIframe").css('position','relative');
			} else {
				$("#showIframe").css('position','absolute');
				$('#leftSide').hide();
				$(this).html('显示');
			}
