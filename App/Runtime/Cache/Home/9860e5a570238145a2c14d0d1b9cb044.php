...
<div class="loginWrapper">
    ...
    <div class="widget">
        <div class="title"><img src="/Public/images//icons/dark/files.png" alt="" class="titleIcon" /><h6>登录</h6></div>
        <form action="" class="form validate ajax_form" method="post">
            <fieldset>
                ...
                <div class="loginControl">
                    <div class="rememberMe"><a href="<?php echo U('Public/register');?>">没有帐号？立即注册</a></div>
