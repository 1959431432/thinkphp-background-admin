...
<div id="rightSide">
   ...
   <!--  <div class="titleArea">
    ...
    <div class="wrapper" style="margin-top: 50px;">
        <!-- Note -->
        <?php if(is_array($messages)): $i = 0; $__LIST__ = $messages;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$msg): $mod = ($i % 2 );++$i; if(($msg["type"]) == "1"): ?><div class="nNote nInformation hideit">
                    <a href="<?php echo U('Message/index');?>">
                        <p><strong>网站提示: </strong><?php echo ($msg["title"]); ?></p>
                    </a>
                </div>
            <?php else: ?>
                <div class="nNote nWarning hideit">
                    <a href="<?php echo U('Message/index');?>">
                        <p><strong>紧急通知: </strong><?php echo ($msg["title"]); ?></p>
                    </a>
                </div><?php endif; endforeach; endif; else: echo "" ;endif; ?>
        <div class="widget">
            <div class="title"><span class="titleIcon"><img src="/Public/images//icons/topnav/settings.png"></span><h6>系统</h6></div>
 ...
 $before_user = session('before_user'); ?>
                <tr>
                    ...
                    <td>
                        <?php echo (date('Y-m-d H:i',$before_user["lastlogin"])); ?>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo (date('Y-m-d H:i',$_user["lastlogin"])); ?>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <?php  if( $hasSign == true ){ echo "已签到"; } else { echo "未签到，<a href='".U('Days/index')."'>去签到</a>"; } ?>
                    </td>
                    <td>
                        用户经验：
                    </td>
                    <td>
                        <?php echo ($_user["level"]); ?>
                    </td>
                </tr>
            </table>
        </div>
