   ...
   <!--  <div class="titleArea">
	...
	<div class="wrapper">
      <div class="bc">
		...
		<div class="widget">
			<ul class="tabs">
				<?php if(is_array($groups)): $i = 0; $__LIST__ = $groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i; if(($i) == "1"): ?><li class="activeTab"><a href="#tab<?php echo ($group["id"]); ?>"><?php echo ($group["title"]); ?></a></li>
					<?php else: ?>
