      ...
      <div class="bc">
       ...
       <!-- Validation form -->
        <form class="form validate" method="post" action="<?php echo U('save');?>">
        	...
        	<fieldset>
                <div class="widget">
                    <div class="title"><img src="/Public/images//icons/dark/alert.png" alt="" class="titleIcon" /><h6>个人资料</h6></div>
                    ...
                    <div class="formRow">
                        <label>我的等级:</label>
                        <div class="formRight">
                            <img src="/Public/images//<?php echo ($_userGroup["img"]); ?>" alt="<?php echo ($_userGroup["title"]); ?>">
                        </div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="formRow">
                        <label>生日:</label>
                        <div class="formRight">
                            <input type="date" name="birth" id="birth" value="<?php echo (date('Y-m-d',$vo["birth"])); ?>"/>
                        </div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="formRow">
                        <label>详细地址:</label>
                        <div class="formRight">
                        <textarea name="address" id="address" placeholder="请填写详细地址" rows='10'><?php echo ($vo["address"]); ?></textarea>
                    ...
                    <div class="formRow">
                        <label>最后登录时间:</label>
                        <div class="formRight">
                        	<?php echo (date('Y-m-d',$vo["lastlogin"])); ?>
                        </div>
                        <div class="clear"></div>
                    </div>
