...
<div id="rightSide">
    ...
    <div class="wrapper">
      ...
      <div class="widgets">
			<div class="oneTwo">
				<div class="widget">
	                <div class="title"><img src="/Public/Admin/images//icons/dark/stats.png" alt="" class="titleIcon"><h6>今日签到</h6></div>
	                <div class="updates">
	                	<?php if(is_array($today)): $i = 0; $__LIST__ = $today;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$day): $mod = ($i % 2 );++$i;?><div class="newUpdate">
		                        <div class="uDone">
		                            <a href="<?php echo U('detail',array('uid'=>$day['uid']));?>" title="查看会员签到记录">
		                            	...
		                            	<strong>
		                            		<img src="/Public/Admin/images//<?php echo (getUserImg($day["uid"])); ?>" style="vertical-align: middle;">
			...
			<div class="oneTwo">
				<div class="widget">
	                <div class="title"><img src="/Public/Admin/images//icons/dark/stats.png" alt="" class="titleIcon"><h6>总签到排名</h6></div>
