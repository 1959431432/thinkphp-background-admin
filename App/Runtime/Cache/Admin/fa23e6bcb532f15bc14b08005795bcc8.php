...
<div id="rightSide">
	...
	<div class="bc">
	    <ul id="breadcrumbs" class="breadcrumbs">
	         ...
	         <li class="current"><a href="<?php echo U('index');?>">节点管理</a></li>
	    </ul>
	    <div class="clear"></div>
	</div>
	  <div class="widget">
          ...
          <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck display dTable">
              ...
              <tbody>
	        	<?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeA">
		       			<td class="center">
		       				<!-- TODO -->
		       				<?php if(($vo["pid"]) == "0"): ?><a href="<?php echo U('',array('pid'=>$vo['id']));?>">
			       					<?php echo ($vo["title"]); ?>
			       				</a>
		       				<?php else: ?>
		       			...
		       			<td class="center"><?php echo $vo['ismenu'] == 1 ? '是': '否';?></td>
		       			<td class="center"><?php echo $vo['istop'] == 1 ? '是': '否';?></td>
