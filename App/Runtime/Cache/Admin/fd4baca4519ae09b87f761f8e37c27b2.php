	...
	<div class="wrapper">
		...
		<div class="bc">
          <ul id="breadcrumbs" class="breadcrumbs">
               ...
               <li class="current"><a href="#">文章栏目</a></li>
          </ul>
          <div class="clear"></div>
       </div>
	  ...
	  <div class="widget">
        <div class="title">
          ...
          <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck display dTable" id="checkAll">
              <thead>
                  <tr>
                    <th>栏目名称</th>
		            <th>调用键</th>
              ...
              <tbody>
	        	<?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeA">
		       			...
		       			<td class="center"><?php echo ($vo["key"]); ?></td>
