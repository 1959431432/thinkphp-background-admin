    ...
    <div class="wrapper">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                 ...
                 <li class=""> <a href="<?php echo U('index');?>">会员分组</a> </li>
        ...
        <form class="form validate" method="post" action="<?php echo U('save');?>">
        	...
        	<fieldset>
                <div class="widget">
                    <div class="title"><img src="/Public/Admin/images//icons/dark/alert.png" alt="" class="titleIcon" /><h6>会员分组表单</h6></div>
                    <div class="formRow">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <span class="formNote"><img src="/Public/Admin/images//level1.png" id="preview"></span>
                        </div>
                        <div class="clear"></div>
                    </div>
