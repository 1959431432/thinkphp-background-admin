...
<div id="rightSide">
    ...
    <div class="wrapper">
        ...
        <form class="form validate" method="post" action="<?php echo U('save');?>">
            ...
            <input type="hidden" name='integral' value="<?php echo ($vo["integral"]); ?>">
        	<fieldset>
                <div class="widget">
                    
                    <div class="title">
                    	<img src="/Public/Admin/images//icons/dark/alert.png" alt="" class="titleIcon" />
                    	<h6>订单管理表单</h6>
                    </div>
                    ...
                    <div class="formRow">
                        <label>消费积分:</label>
                        <div class="formRight">
                            <input type="text" class="" name="" id="" value="<?php echo ($vo["integral"]); ?>" disabled="disabled"/>
                        </div>
                        <div class="clear"></div>
                    </div>
