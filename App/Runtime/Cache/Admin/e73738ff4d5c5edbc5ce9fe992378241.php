...
<div id="rightSide">
    ...
    <div class="wrapper">
        ...
        <form class="form validate" method="post" action="<?php echo U('save');?>">
        	...
        	<fieldset>
                <div class="widget">
                    <div class="title"><img src="/Public/Admin/images//icons/dark/alert.png" alt="" class="titleIcon" /><h6>会员表单</h6></div>
                    ...
                    <div class="formRow">
                        <label>签到天数:</label>
                        <div class="formRight">
                            <input type="number" name="days" id="days" value="<?php echo (signSumDay($vo["id"])); ?>" disabled="disabled" />
                        </div>
                        <div class="clear"></div>
                    </div>
