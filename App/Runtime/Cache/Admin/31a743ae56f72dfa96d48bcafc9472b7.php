	...
	<div class="wrapper">
		<div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                 ...
                 <li class="current"><a href="#">网站统计</a></li>
            </ul>
            <div class="clear"></div>
        </div>
	  <div class="widget">
          ...
          <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck display">
              ...
              <tbody>
	        	<?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeA">
		       			<td class="center"><?php echo (date("Y-m-d",$vo["id"])); ?></td>
                <td class="center"><?php echo ($vo["login_number"]); ?></td>
		       			<td class="center"><?php echo ($vo["register_number"]); ?></td>
		       			<td class="center"><?php echo ($vo["download"]); ?></td>
		       			<td class="center"><?php echo ($vo["link_number"]); ?></td>
