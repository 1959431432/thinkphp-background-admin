    ...
    <div class="wrapper">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                 ...
                 <li class=""> <a href="<?php echo U('index');?>">商品列表</a> </li>
        ...
        <form class="form validate" method="post" action="<?php echo U('save');?>">
        	...
        	<fieldset>
                <div class="widget">
                    <div class="title"><img src="/Public/Admin/images//icons/dark/alert.png" alt="" class="titleIcon" /><h6>文章表单</h6></div>
                    <div class="formRow">
                    ...
                    <div class="formRow">
                        <label>商品外链:</label>
                        <div class="formRight"><input type="text" class="validate[required]" name="link" id="link" value="<?php echo ($vo["link"]); ?>"/>
                        <span class="formNote">＊填写之后点开详情将跳转到该网址</span>
                        </div>
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <img alt="图片预览" src="/<?php echo C('UPLOAD_CONFIG.rootPath'); echo ($vo["img"]); ?>" id="showImg" width="101px" height="101px" onerror="this.src='/Public/Admin/images//img.png'">
                        </div>
                        <div class="clear"></div>
                    </div>
