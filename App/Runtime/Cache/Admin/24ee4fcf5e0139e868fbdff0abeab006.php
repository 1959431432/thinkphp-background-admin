        	...
        	<fieldset>
                <div class="widget">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <select id="" name="pid" class="" ><option value="" >顶级节点</option><?php  foreach($rules as $key=>$val) { if( $vo.pid == $val[title]){ ?><option value="<?php echo $val[id]; ?>" selected="selected"><?php echo $val[title]; ?></option><?php }else{ ?><option value="<?php echo $val[id]; ?>"><?php echo $val[title]; ?></option><?php } } ?></select>
                        </div>
                        <div class="clear"></div>
                    </div>
