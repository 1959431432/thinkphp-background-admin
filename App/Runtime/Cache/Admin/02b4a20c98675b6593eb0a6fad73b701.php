...
<div id="rightSide">
	...
	<div class="bc">
	    <ul id="breadcrumbs" class="breadcrumbs">
	         ...
	         <li class="current"><a href="#">管理员列表</a></li>
	    </ul>
	    <div class="clear"></div>
	</div>
	  <div class="widget">
        <div class="title">
		  ...
		  <h6 class="fr">
		  	<form class='form'>
		  		<input type="text" class='searchInput' name="user" placeholder="请输入管理员名称" value="<?php echo ($_GET['user']); ?>" /> 
          ...
          <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck display myTable">
              ...
              <tbody>
	        	<?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeA">
		       			<td class="center searchContent"><?php echo ($vo["user"]); ?></td>
