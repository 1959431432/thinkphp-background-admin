    ...
    <div class="wrapper">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                 ...
                 <li class=""> <a href="<?php echo U('index');?>">网站配置</a> </li>
                 <li class="current"><a href="#">配置管理</a></li>
            </ul>
            <div class="clear"></div>
        </div>
        <!-- Validation form -->
        <form class="form validate" method="post" action="<?php echo U('save');?>">
        	...
        	<fieldset>
                <div class="widget">
                    <div class="title"><img src="/Public/Admin/images//icons/dark/alert.png" alt="" class="titleIcon" /><h6>友情链接表单</h6></div>
                    <div class="formRow">
                        <label>网址:<span class="req">*</span></label>
                        <div class="formRight">
                            <input type="text" class="validate[required]" name="url" id="req" value="<?php echo ($vo["url"]); ?>"/>
                            <span class="formNote">＊不加HTTP或者HTTPS</span>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <input type="text" class="validate[required]" name="order" id="req" value="<?php echo ((isset($vo["order"]) && ($vo["order"] !== ""))?($vo["order"]):0); ?>"/>
                        </div>
                        <div class="clear"></div>
                    </div>
