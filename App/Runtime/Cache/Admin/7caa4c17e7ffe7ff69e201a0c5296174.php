    ...
    <div class="wrapper">
        <div class="bc">
          <ul id="breadcrumbs" class="breadcrumbs">
               ...
               <li class=""> <a href="<?php echo U('Category/index');?>">文章栏目</a> </li>
               <li class="current"><a href="#">栏目管理</a></li>
          </ul>
          <div class="clear"></div>
       </div>
        <!-- Validation form -->
        <form class="form validate" method="post" action="<?php echo U('save');?>">
        	...
        	<fieldset>
                <div class="widget">
                    <div class="title"><img src="/Public/images//icons/dark/alert.png" alt="" class="titleIcon" /><h6>文章栏目表单</h6></div>
                    <div class="formRow">
                        <label>栏目名称:<span class="req">*</span></label>
                        <div class="formRight"><input type="text" id="category_name" class="validate[required]" name="title" id="req" value="<?php echo ($vo["title"]); ?>"/></div><div class="clear"></div>
                    </div>
                    
                    <div class="formRow">
                        <label>调用键:<span class="req">*</span></label>
                        <div class="formRight"><input type="text" id="category_key" class="validate[required,custom[onlyLetterSp]]" name='key' value="<?php echo ($vo["key"]); ?>" /></div><div class="clear"></div>
                    </div>

                    <div class="formRow">
                        <label>显示位置:</label>
                        <div class="formRight"><input type="number" value="<?php echo ((isset($vo["position"]) && ($vo["position"] !== ""))?($vo["position"]):0); ?>" name='position' /></div><div class="clear"></div>
                    </div>
